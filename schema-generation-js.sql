...
-- Schema alinedb-js
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `alinedb-js` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `alinedb-js` ;

-- -----------------------------------------------------
-- Table `alinedb-js`.`bank`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-js`.`bank` (
...
-- -----------------------------------------------------
-- Table `alinedb-js`.`branch`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-js`.`branch` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `address` VARCHAR(255) NOT NULL,
  `city` VARCHAR(255) NOT NULL,
...
-- -----------------------------------------------------
-- Table `alinedb-js`.`applicant`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-js`.`applicant` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `address` VARCHAR(255) NOT NULL,
  `city` VARCHAR(255) NOT NULL,
...
-- -----------------------------------------------------
-- Table `alinedb-js`.`member`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-js`.`member` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `FK1uj76dnpxoa9i8afaaslycb59`
    ...
    REFERENCES `alinedb-js`.`branch` (`id`),
  CONSTRAINT `FKmhn91ma4lb6uiy6n1ao6tbwkj`
    FOREIGN KEY (`applicant_id`)
    REFERENCES `alinedb-js`.`applicant` (`id`))
ENGINE = InnoDB
AUTO_INCREMENT = 2
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `alinedb-js`.`account`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-js`.`account` (
  ...
  CONSTRAINT `FK8mr193rmld8wwqn5nlbr8vclx`
    ...
    REFERENCES `alinedb-js`.`member` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `alinedb-js`.`account_holder`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-js`.`account_holder` (
  ...
  CONSTRAINT `FKn4212xs4wsfh8cfj9rddju6ic`
    ...
    REFERENCES `alinedb-js`.`account` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `alinedb-js`.`account_sequence`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-js`.`account_sequence` (
...
-- -----------------------------------------------------
-- Table `alinedb-js`.`application`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-js`.`application` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `alinedb-js`.`application_applicant`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-js`.`application_applicant` (
  ...
  CONSTRAINT `FKahrhusgia8sp6xy44fbjhc1po`
    ...
    REFERENCES `alinedb-js`.`application` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `alinedb-js`.`merchant`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-js`.`merchant` (
...
-- -----------------------------------------------------
-- Table `alinedb-js`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-js`.`user` (
...
-- -----------------------------------------------------
-- Table `alinedb-js`.`one_time_passcode`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-js`.`one_time_passcode` (
  `id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `alinedb-js`.`otp_sequence`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-js`.`otp_sequence` (
  `next_val` BIGINT NULL DEFAULT NULL)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `alinedb-js`.`transaction`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-js`.`transaction` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `amount` INT NOT NULL,
  ...
  CONSTRAINT `FKsc1ms700fjxqyq0j4555uc28a`
    ...
    REFERENCES `alinedb-js`.`merchant` (`code`))
ENGINE = InnoDB
AUTO_INCREMENT = 3
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `alinedb-js`.`user_registration_token`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-js`.`user_registration_token` (
